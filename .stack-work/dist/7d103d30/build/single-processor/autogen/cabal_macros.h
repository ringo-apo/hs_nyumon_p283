...
/* package pallel-sample-0.1.0.0 */
#ifndef VERSION_pallel_sample
#define VERSION_pallel_sample "0.1.0.0"
#endif /* VERSION_pallel_sample */
#ifndef MIN_VERSION_pallel_sample
#define MIN_VERSION_pallel_sample(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pallel_sample */
...
#define CURRENT_COMPONENT_ID "pallel-sample-0.1.0.0-FyWL36JRVU8JEmZqAvdZxr-single-processor"
